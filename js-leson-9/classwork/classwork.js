...
//         img.src = arrayElement.photo;
//         div.innerText = `${arrayElement.name} ${arrayElement.surname} ${arrayElement.age} ${arrayElement.info}`;
//         div.appendChild(img)
...
//             let div = document.createElement('div');
//             if (arrayElement[arrayKey] !== arrayElement.photo) {
//                 div.innerText = arrayElement[arrayKey];
//             }
//             divMember.appendChild(div);
//             div.appendChild(img)
//         }
...
//         title.append(arrayElement.title);
//         monthDuration.append(arrayElement.monthDuration);
//         hourDuration.append(arrayElement.hourDuration);
//         modules.append(arrayElement.modules);
//         let ul = document.createElement('ul');
//         for (let modulesKey in arrayElement.modules) {
//             let li = document.createElement('li');
//             li.innerText = arrayElement.modules[modulesKey];
//             ul.appendChild(li);
//         }
